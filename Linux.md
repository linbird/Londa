...
整体架构上，对于用户内存空间使用**`malloc()\free()`**的方式对内存进行管理，而对于内核使用`Slab`或者`vmalloc`的方式对内存进行管理（内核向外提供了[**`kmalloc()\kfree()、vmalloc()\vfree()`**](# 其他分配函数)两组内存管理接口函数）。在此之上，liunx统一使用`Buddy System`提供了更加灵活的内存管理方式。
...
linux 自旋锁和信号量_xu_guo的专栏-CSDN博客
https://blog.csdn.net/xu_guo/article/details/6072823

【原创】linux spinlock/rwlock/seqlock原理剖析（基于ARM64） - LoyenWang - 博客园
https://www.cnblogs.com/LoyenWang/p/12632532.html

Linux内核同步 - AlanTu - 博客园
https://www.cnblogs.com/alantu2018/p/8997348.html

真棒！ 20 张图揭开内存管理的迷雾，瞬间豁然开朗
https://mp.weixin.qq.com/s?__biz=MzUxODAzNDg4NQ==&mid=2247485033&idx=1&sn=bf9ba7aca126ad186922c57a96928593&scene=21#wechat_redirect

Linux内存管理（最透彻的一篇）_有趣的人生 一半是山川湖海 一半是初心情怀 -CSDN博客
https://blog.csdn.net/ds1130071727/article/details/92795878

内核中断，异常，抢占总结篇_vivi的技术博客-CSDN博客
https://blog.csdn.net/vividonly/article/details/6609053

Linux 虚拟内存和物理内存的理解_张勤一-CSDN博客
https://blog.csdn.net/dlutbrucezhang/article/details/9058583

Linux分页机制之概述--Linux内存管理(六)_OSKernelLAB(gatieme)-CSDN博客_linux 内存分页
https://blog.csdn.net/gatieme/article/details/52402861

分段，分页与段页式存储管理_zephyr_be_brave的专栏-CSDN博客
https://blog.csdn.net/zephyr_be_brave/article/details/8944967
